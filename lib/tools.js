...
function polyline(x1,y1,x2,y2,x3,y3,x4,y4,col,width){
	...
	polylines[polylineCount]=svg.polyline([x1,y1,x2,y2,x3,y3,x4,y4]).attr({
		fill:"none" ,stroke:col ,strokeWidth:width
	});

	polylines[polylineCount].attr({
		markerStart: "none",
		markerMid: "none",
		markerEnd: marker,
		zIndex:3
